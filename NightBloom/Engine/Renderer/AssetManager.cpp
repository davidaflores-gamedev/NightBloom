...
namespace Nightbloom
{
	...
	{
		LOG_INFO("=== AssetManager Debug ===");
		LOG_INFO("basePathHint: {}", basePathHint);
		...
		LOG_INFO("exePath: {}", exePath.string());
		LOG_INFO("exePath.parent_path(): {}", exePath.parent_path().string());
